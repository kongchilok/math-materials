...
d.eqTable({
  ...
  rows: [
    ...
    [{ eq: [{ n: '1', d: { sqrt: { base: 'a', exp: '5' }, deg: '3' } }] }, { eq: [{ base: 'a', exp: ['−', { n: '5', d: '3' }] }] }, '喺分母 → 指數加負號'],
  ],
});
...
d.layered({
  ...
  cols: [
    ...
    { stars: '★★☆', head: '練習 B', lines: [
      ...
      { eq: ['② ', { n: '1', d: { sqrt: { base: 'a', exp: '5' }, deg: '3' } }, ' = ?'] }, '',
...
d.rows3({
  ...
  rows: [
    ...
    { icon: '③', term: '次方再次方', desc: '兩個指數相乘',
      egParts: [{ base: ['(', { base: '2', exp: '3' }, ')'], exp: { n: '2', d: '3' } }, ' = ', { base: '2', exp: ['3 × ', { n: '2', d: '3' }] }, ' = ', { base: '2', exp: '2' }] },
  ],
});
...
d.compareCards({
  ...
  cards: [
    { ok: false,
      text: { eq: ['3', { base: 'a', exp: '-2' }, ' = ', { n: '1', d: ['3', { base: 'a', exp: '2' }] }] },
      note: { eq: ['負指數淨係搬 a，個 3 唔跟住落分母 → 應該係 ', { n: '3', d: { base: 'a', exp: '2' } }] } },
    { ok: false,
      text: { eq: [{ sqrt: { base: '2', exp: '4' }, deg: '3' }, ' = ', { base: '2', exp: { n: '3', d: '4' } }] },
      note: { eq: ['根指數 3 落分母、次方 4 上分子 → 應該係 ', { base: '2', exp: { n: '4', d: '3' } }] } },
    { ok: true,
      text: { eq: [{ base: 'a', exp: { n: '2', d: '3' } }, ' ÷ ', { base: 'a', exp: { n: '1', d: '3' } }, ' = ', { base: 'a', exp: { n: '1', d: '3' } }] },
      note: { eq: ['底數一樣，指數相減：', { n: '2', d: '3' }, ' − ', { n: '1', d: '3' }, ' = ', { n: '1', d: '3' }] } },
  ],
  badge: '逐張讀一次',
});
...
d.summary({
  ...
  lines: [
    ...
    { eq: ['② 喺分母 → 指數加負號：', { n: '1', d: { base: 'a', exp: 'n' } }, ' = ', { base: 'a', exp: '-n' }] },
    '③ 轉咗做指數：乘就加、除就減、次方就相乘',
  ],
});
